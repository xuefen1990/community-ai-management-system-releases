...
const MODULES = { personnel: 'personnel', households: 'personnel', partyMembers: 'party', partyActivists: 'party', visitRecords: 'visit', dutyRecords: 'work', workItems: 'work', workEvidence: 'work', workProgressRecords: 'work', workResourceEntries: 'work', workAcceptances: 'work', lands: 'land', landParcel: 'land', finances: 'finance', resourceContracts: 'finance', contractFeeLedgers: 'finance', contractFeeBatches: 'finance', contractFeeReceipts: 'finance', contractFeeAdvances: 'finance', certificates: 'certificate', documents: 'document', documentDrafts: 'document', documentVersions: 'document', documentReferences: 'document', documentDraftMessages: 'document', documentTemplates: 'document', writingProfiles: 'document' };
...
module.exports = { read, write, subscribe, moduleFor };
