...
(function contractFeeWorkspace(root) {
  ...
  async function importDisbursementExcel() {
    ...
    if (result.data?.requiresMapping) { notify('未能可靠识别表头，请先按提示确认字段映射', 'warning'); return; }
